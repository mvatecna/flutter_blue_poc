...
class DeviceInteractionTab extends StatelessWidget {
  ...
  const DeviceInteractionTab({required this.device, super.key});
...
class _DeviceInteractionTab extends StatefulWidget {
  const _DeviceInteractionTab({required this.viewModel});
...
class _ServiceDiscoveryList extends StatefulWidget {
  const _ServiceDiscoveryList({required this.deviceId, required this.discoveredServices});
...
class _ServiceDiscoveryListState extends State<_ServiceDiscoveryList> {
  ...
  Widget _characteristicTile(DiscoveredCharacteristic characteristic, String deviceId) => ListTile(
